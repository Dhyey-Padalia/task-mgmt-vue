  ...
  <div class="navbar">
    ...
    >
      ...
      >
        ...
        >
          <img
            src="https://steepgraph.com/wp-content/uploads/2022/05/steepgraph-logo-white-color.png"
            class="h-8"
            alt="Flowbite Logo"
          />
          <span
          ...
          >
            <li>
              <a
                ...
                aria-current="page"
                @click="$emit('filter-tasks', 'Pending')"
                >Pending</a
              >
            </li>
            <li>
              <a
                href="#"
                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                @click="$emit('filter-tasks', 'In Progress')"
                >In Progress</a
              >
            </li>
            <li>
              <a
                ...
                @click="$emit('filter-tasks', 'Completed')"
                >Completed</a
              >
            </li>
            <!-- <li>
...
export default {
  ...
  methods: {
    emitSearch() {
      ...
      this.$emit("urgent-task", this.filterurg);
    },
  },
};
</script>
